...
![Preview](abbie_tring_bacame_calm_cover.png)
...
## How to use
* **Linux:** Download the original `FPE_Abbie_and_Oliver_Park_Idle_Rain.mp4` or `FPE_Abbie_Park_Idle_Rain.mp4` and use it with your favorite wallpaper manager (like `mpvpaper`, `swww` or `linux-wallpaperengine`) or as a background for your SDDM theme.
* **Windows:** Subscribe to the wallpaper directly via the Steam Wallpaper Engine links above or download video file and use different software for live wallpapers.
